...
<p align="center">
<b>apt update && apt-get -y install git && git clone https://github.com/emue25/openvpndeb && cd openvpndeb && chmod +x openvpn.sh && ./openvpn.sh</b>
  </p>
  
<h3 align="center"><font color="blue">Server with OCS Panel by Bon-chan</h4></font>
<p align="center">
<b>apt update && apt-get -y install git && git clone https://github.com/emue25/openvpndeb && cd openvpndeb && chmod +x DebianOCS-Panel && chmod +x openvpn.sh && ./DebianOCS-Panel && ./openvpn.sh</b>
  </p>
